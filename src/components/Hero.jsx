...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      <div className="hero-bg absolute inset-0 z-0 w-full min-h-[52vh] md:min-h-[100dvh]">
        <OptimizedImage
          src={heroImage}
      ...
      <div className="relative z-10 text-center text-white px-4 max-w-4xl mx-auto flex flex-col items-center justify-center gap-2 md:gap-6 py-12 md:py-0 pb-2 md:pb-0 md:pt-24">
        <motion.div
        ...
        >
          <OptimizedImage
            ...
            priority
            className="h-28 w-auto mx-auto drop-shadow-2xl md:hidden"
          ...
          <OptimizedImage
            ...
            alt="Cabañas Arcángeles"
            priority
            className="h-36 lg:h-60 w-auto mx-auto drop-shadow-2xl hidden md:block"
            style={{ filter: 'drop-shadow(2px 2px 8px rgba(0, 0, 0, 0.8)) drop-shadow(0 0 20px rgba(0, 0, 0, 0.5))' }}
          />
        </motion.div>

        <motion.p 
          className="text-[clamp(18px,1.5vw,26px)] leading-tight md:text-xl lg:text-4xl max-w-4xl mx-auto lg:mb-3 lg:mt-6 drop-shadow-2xl font-display font-semibold"
