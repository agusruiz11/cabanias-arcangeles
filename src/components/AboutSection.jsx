...
import environmentImg from '../assets/imgs/environment.jpg';
...
function AboutSection() {
  return (
    <section
      id="about"
      className="scroll-mt-24 bg-brand-beige-pale pt-12 pb-8 sm:pt-16 sm:pb-10"
    ...
    >
      <div className="w-full px-4 sm:px-6 md:px-0">
        ...
        >
          ...
          <div className="hidden md:flex md:flex-row gap-10 items-center mb-10">
            <div className="flex-1">
              ...
              <p className="mt-4 text-lg text-brand-dark-green/80">
                Inauguradas en 2007, las Cabañas Arcángeles ofrecen un lugar tranquilo rodeado de naturaleza, a metros del Lago Gutiérrez. <br/> Atendidos por sus dueños, buscamos que cada huésped disfrute plenamente de su experiencia y se sienta como en casa.
              </p>
            </div>
            <div className="flex-1 rounded-2xl overflow-hidden shadow-lg" style={{ maxHeight: '300px' }}>
              <OptimizedImage
                src={environmentImg}
                alt="Entorno de Cabañas Arcángeles"
          ...
          <p className="mt-8 text-lg text-brand-dark-green/80 sm:mb-4">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            >
              ...
              <div className="flex items-baseline gap-1.5">
                <span className="font-sans text-2xl font-medium text-brand-dark-green">9.4</span>
                <span className="text-base text-brand-dark-green/70">/ 10</span>
              </div>
              <span className="inline-flex items-center gap-1.5 font-sans text-base font-medium text-brand-dark-green">
            ...
            >
              ...
              />
              <div className="flex items-baseline gap-1.5">
                <span className="font-sans text-2xl font-medium text-brand-dark-green">4.7</span>
                <span className="text-base text-brand-dark-green/70">/ 5</span>
              </div>
              <span className="inline-flex items-center gap-1.5 font-sans text-base font-medium text-brand-dark-green">
                Ver en Google Maps
                <ExternalLink className="h-3.5 w-3.5 shrink-0 opacity-70 group-hover:opacity-100" aria-hidden />
          ...
          >
            ...
            <p className="font-sans text-center text-xl text-brand-dark-green/80">
              Seguinos en Instagram
            </p>
            <span className="inline-flex items-center gap-1.5 font-sans text-base font-semibold text-brand-dark-green group-hover:text-[#e1306c] transition-colors">
              @arcangelesbariloche
