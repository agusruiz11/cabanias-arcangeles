        ...
        >
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            >
              ...
              <span className="inline-flex items-center gap-1.5 font-display text-base font-medium text-brand-dark-green">
          ...
          >
            ...
            <p className="font-display text-center text-xl text-brand-dark-green/80">
